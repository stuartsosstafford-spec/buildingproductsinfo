---
title: "DeWalt Titanium S3 Safety Boots"
category: "site-equipment-ppe"
brand: "DeWalt"
modelNumber: "Titanium"
shortDescription: "S3 rated waterproof safety boots with steel toe cap and midsole protection, designed for all-day comfort on construction sites."
featuredImage: "https://m.media-amazon.com/images/I/61NQZLqHpkS._SL500_.jpg"
keyFeatures:
  - "S3 safety rated — steel toe cap and penetration-resistant midsole"
  - "Waterproof full-grain leather upper"
  - "Padded collar and tongue for all-day comfort"
  - "Oil and slip resistant rubber outsole"
  - "200 joule steel toe cap impact protection"
  - "Lightweight construction for reduced fatigue"
specifications:
  - label: "Safety Rating"
    value: "S3 SRA"
  - label: "Toe Protection"
    value: "Steel toe cap (200J)"
  - label: "Midsole"
    value: "Steel penetration-resistant"
  - label: "Upper"
    value: "Full-grain waterproof leather"
  - label: "Sole"
    value: "Rubber, oil and slip resistant"
  - label: "Standard"
    value: "EN ISO 20345:2011"
overview: "The DeWalt Titanium has been one of the best-selling safety boots in the UK construction industry for years. Its combination of S3 protection, waterproof leather upper, and genuine all-day comfort makes it the boot that tradespeople replace with the same model when it wears out — which is the best endorsement any safety boot can get."
whoItsFor:
  - "Construction workers needing S3 rated site boots"
  - "Tradespeople working outdoors in wet conditions"
  - "Anyone requiring comfortable, protective footwear for long working days"
prosAndCons:
  pros:
    - "S3 rated with steel toe and midsole — meets all UK site requirements"
    - "Waterproof leather keeps feet dry in wet conditions"
    - "Comfortable enough for 10+ hour days on site"
    - "Proven durability — holds up to heavy construction use"
  cons:
    - "Steel toe is heavier than composite alternatives"
    - "Break-in period of a few days before full comfort"
