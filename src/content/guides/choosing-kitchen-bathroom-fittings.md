---
title: "How to Choose Kitchen and Bathroom Fittings"
...
Stainless steel remains the most popular sink material in the UK for good reason. It is hygienic, heat-resistant, and straightforward to maintain. Gauge matters: thinner gauges (higher numbers) flex and sound tinny under running water. The [Franke Reno Stainless Steel Kitchen Sink](/interiors-kitchens-bathrooms/franke-reno-stainless-steel-kitchen-sink/) is a well-made mid-market option with adequate thickness to dampen vibration, and the inset fitting keeps installation simple across most worktop materials.

Composite sinks — made from granite or quartz particles bonded with resin — offer a harder, more scratch-resistant surface and are available in a wider range of colours. The [Blanco Subline 500-U Silgranit Undermount Sink](/interiors-kitchens-bathrooms/blanco-subline-500u-silgranit-sink/) uses Blanco's proprietary Silgranit material, which resists staining and stands up well to heat. Undermount fitting gives a cleaner worktop line, though it requires a solid surface or stone worktop that can be routed from below — not suitable for laminate.
...
The [Bristan Artisan Easyfit Kitchen Tap](/interiors-kitchens-bathrooms/bristan-artisan-easyfit-kitchen-tap/) is a pragmatic choice for retrofit work: it includes a flexible supply hose and a simplified fixing arrangement that reduces under-sink fiddling. For a more premium finish, the [Grohe Essence Kitchen Mixer Tap](/interiors-kitchens-bathrooms/grohe-essence-kitchen-mixer-tap/) has a slimmer, more contemporary profile and uses Grohe's StarLight chrome finish, which holds its appearance well without pitting.
...
The enclosure type is usually dictated by the bathroom layout rather than preference. A quadrant enclosure works well in a corner where both walls are adjacent — the [ELEGANT Quadrant Shower Enclosure 900mm](/interiors-kitchens-bathrooms/elegant-quadrant-shower-enclosure-900mm/) is a solid entry-level option with 6mm safety glass and a reversible door that accommodates both left and right-hand configurations. For a more open feel in a larger bathroom, a walk-in panel with a deflector removes the need for a door mechanism entirely, which cuts down on maintenance.
...
The [Grohe Grohtherm 1000 Thermostatic Shower Mixer](/interiors-kitchens-bathrooms/grohe-grohtherm-1000-thermostatic-shower-mixer/) is a widely specified two-handle bar valve with a separate temperature and flow control — the layout is intuitive and suits both concealed and surface-mount installations. For a step up in functionality, the [Hansgrohe Ecostat Thermostatic Shower Mixer](/interiors-kitchens-bathrooms/hansgrohe-ecostat-thermostatic-shower-mixer/) adds Hansgrohe's Select button technology, allowing push-button start and stop without altering the temperature setting.
...
The [Roca The Gap Rimless Wall Hung WC](/interiors-kitchens-bathrooms/roca-gap-rimless-wall-hung-wc/) pairs with a suitable frame — the [Grohe Rapid SL WC Frame](/interiors-kitchens-bathrooms/grohe-rapid-sl-wc-frame/) is a well-regarded option that accommodates pans from most manufacturers and adjusts to suit floor-to-ceiling height. Rimless pan designs have become the norm because they eliminate the ledge that harbours bacteria, making cleaning significantly easier.

A soft-close toilet seat is a straightforward upgrade worth specifying on any WC. The [SA Products Soft Close Toilet Seat](/interiors-kitchens-bathrooms/sa-products-soft-close-toilet-seat/) is an economical option that retrofits to most standard pan fixings, with a quick-release mechanism for cleaning.
...
In a cloakroom where space is limited, a compact semi-recessed or wall-mounted basin keeps the floor visible and the room feeling larger. The [Vitra S20 Cloakroom Basin](/interiors-kitchens-bathrooms/vitra-s20-cloakroom-basin/) is a well-proportioned option in a small format, suitable for a single central tap hole.

Basin taps should be matched to the water pressure available. The [Ideal Standard Concept Air Basin Mixer Tap](/interiors-kitchens-bathrooms/ideal-standard-concept-air-basin-mixer/) is a quality mixer with a ceramic disc cartridge, but confirm whether it is specified for high or low pressure — some mixer taps are not suitable for gravity-fed supplies without an inline pressure-balancing kit.

## Towel Rails and Bathroom Radiators

A heated towel rail serves a dual purpose: it keeps towels dry and contributes to the bathroom heat load. Chrome ladder-style towel rails are the standard choice and suit most bathroom styles. The [Milano Chrome Heated Towel Rail](/interiors-kitchens-bathrooms/milano-chrome-heated-towel-rail/) is a straightforward central heating-fed option available in a range of heights and widths, and its BTU output should be checked against the calculated heat loss for the room.

For a less utilitarian look, a flat-panel or wave-pattern designer radiator gives a stronger visual statement. The [Hudson Reed Revive Designer Radiator](/interiors-kitchens-bathrooms/hudson-reed-revive-designer-radiator/) is a vertical radiator with a strong output relative to its footprint, which suits narrow wall spaces where a horizontal rail would not perform adequately.
...
For a simpler accessory rail not connected to the heating system, the [Croydex Flexi-Fix Towel Rail](/interiors-kitchens-bathrooms/croydex-flexi-fix-towel-rail-chrome/) installs without drilling by gripping to the tile surface — a useful solution in rented properties or where drilling is not practical.
