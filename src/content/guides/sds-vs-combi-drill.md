---
title: "SDS Drill vs Combi Drill — Which Do You Need?"
category: "Tools"
author: "Editorial Team"
publishDate: 2026-03-09
metaTitle: "SDS Drill vs Combi Drill — Which Do You Need? | Buying Guide"
metaDescription: "Confused about SDS vs combi drills? This guide explains the differences, when to use each, and which is worth buying for trade or serious DIY use."
draft: false
faq:
  - question: "Can a combi drill drill into concrete?"
    answer: "Yes but only for light masonry (screws into brick mortar etc). For structural concrete, block, or dense stone, an SDS+ drill is needed — its impact mechanism delivers far more energy per blow."
  - question: "What does SDS stand for?"
    answer: "SDS stands for Slotted Drive System (originally Steck-Dreh-Sitzt, a German term). It describes the bit retention system where the bit slots and locks into the chuck, allowing it to move axially — the key to the hammering mechanism."
  - question: "Do I need both an SDS drill and a combi drill?"
    answer: "For most tradespeople, yes. A combi drill handles wood, metal, and light masonry plus all screwdriving. An SDS+ handles structural concrete, blockwork, and chasing. They are complementary tools, not alternatives."
  - question: "What size SDS drill do I need?"
    answer: "SDS+ handles drilling up to around 26mm in concrete and is right for the vast majority of trade work. SDS Max is for large-diameter holes (30mm+) and heavy breaking work — overkill for most applications."
relatedProducts:
...
The [Makita DHR242 SDS+ rotary hammer](/tools/makita-dhr242-sds-rotary-hammer/) is a strong cordless choice for most trade applications. It delivers 2.0J of impact energy in a compact 18V platform, handling the majority of structural masonry drilling encountered on a typical build or fit-out.
...
Most screwdriving on site is done with a combi drill or a dedicated impact driver. The [DeWalt DCD796 combi drill](/tools/dewalt-dcd796-combi-drill/) is a compact 18V brushless tool well suited to a full day of drilling and driving across mixed materials.
