---
title: "How to Choose Underfloor Heating — Wet vs Electric Systems"
...
faq:
  - question: "Is wet or electric underfloor heating cheaper to run?"
    answer: "Wet systems are significantly cheaper to run when connected to a heat pump or modern condensing boiler. Electric systems cost more to run but are cheaper to install and better suited to single rooms or retrofit projects."
  - question: "Can underfloor heating work under any floor finish?"
    answer: "Most floor finishes are compatible, but thermal resistance (tog rating) matters. The combined tog rating of floor finish and floor coverings should ideally be below 1.5 tog. Stone and tile are ideal. Engineered timber works well. Thick carpet (above 2.5 tog) significantly reduces output."
  - question: "What flow temperature does wet UFH need?"
    answer: "Wet underfloor heating typically operates at 35–45°C flow temperature, compared to 60–80°C for radiators. This makes it highly efficient with heat pumps, which operate best at low flow temperatures. Many modern condensing boilers also benefit from lower flow temperatures."
  - question: "Do I need planning permission for underfloor heating?"
    answer: "No planning permission is required for underfloor heating itself. However, if it's part of a new build or extension, the installation must comply with Part L of the Building Regulations (energy efficiency). Heat pump installations may require notification under Permitted Development rules."
relatedProducts:
