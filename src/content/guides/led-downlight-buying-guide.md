---
title: "LED Downlight Buying Guide — Fire Rating, CCT, and Dimming"
...
faq:
  - question: "Do all downlights need to be fire rated?"
    answer: "Downlights must be fire rated when installed in a ceiling that forms a fire-compartment boundary — typically between floors in a two-storey property or above a garage. Approved Document B requires the fire integrity of the ceiling to be maintained. In a single-storey room, fire rating is not strictly required but is often specified as good practice."
  - question: "What does IC rated mean?"
    answer: "IC (Insulation Contact) rated downlights are designed to be in direct contact with thermal insulation in the ceiling void. Non-IC rated downlights require a 75mm clearance from insulation — which is often impractical. Always use IC-rated downlights where insulation is present."
  - question: "What colour temperature should I choose?"
    answer: "2700K is warm white (similar to traditional incandescent), suited to living rooms and bedrooms. 3000K is a slightly cooler warm white popular in kitchens and bathrooms. 4000K (cool white) is used in commercial and task lighting. CCT-adjustable downlights let you switch between temperatures."
  - question: "Why don't my LED downlights dim smoothly?"
    answer: "LED dimming requires a compatible LED dimmer switch, not a standard trailing-edge or leading-edge incandescent dimmer. Check the downlight manufacturer's list of compatible dimmers. Minimum load requirements can also cause flickering at low dim levels with small numbers of fittings."
relatedProducts:
...
The [Luceco F-Type Mk2 CCT fire-rated downlight](/electrical-lighting/luceco-ftype-mk2-cct-fire-rated-downlight/) and [Collingwood H2 Lite](/electrical-lighting/collingwood-h2-lite-fire-rated-downlight/) are among the most widely used fire-rated downlights in UK domestic installation. The [Aurora EnLite](/electrical-lighting/aurora-enlite-fire-rated-downlight/) is another consistently reliable choice. All three carry the required 60-minute fire resistance rating and are IC-rated.
