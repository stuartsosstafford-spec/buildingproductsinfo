---
title: "How to Choose the Right Insulation for Your Project"
...
faq:
  - question: "What is lambda value in insulation?"
    answer: "Lambda (λ) is thermal conductivity, measured in W/mK. The lower the lambda, the better the insulating performance per millimetre of thickness. Rigid PIR boards (e.g. Celotex, Kingspan) typically achieve λ0.022, mineral wool around λ0.032–0.044. Lambda is the correct figure to compare products on, not R-value alone."
  - question: "How thick does my insulation need to be?"
    answer: "Thickness depends on the lambda value of the product, the available space, and the target U-value required by Building Regulations (typically 0.18 W/m²K for roofs, 0.28 for walls, 0.18 for floors in new build). Use a U-value calculator with the specific product's lambda to determine the required thickness for your build-up."
  - question: "Is spray foam insulation a problem for mortgages?"
    answer: "Spray foam insulation applied to roof rafters has caused significant problems for homeowners seeking to sell or remortgage, as many lenders refuse properties where it has been installed — due to concerns about roof structure inspection and future removal costs. It is not generally recommended for domestic roof spaces. Always check with a structural engineer before using spray foam."
  - question: "Can I use rigid insulation in a timber frame wall?"
    answer: "Yes. Rigid PIR boards are commonly used in timber frame construction, both as continuous insulation between studs (with thermal bridging consideration) and as external insulation over sheathing. Ensure vapour control and wind-tightness layers are correctly specified for the wall build-up."
relatedProducts:
  - celotex-ga4000-insulation-board
  - tyvek-supro-breather-membrane
  - dpm-1200-gauge-damp-proof-membrane
...
The [Celotex GA4000 insulation board](/building-materials/celotex-ga4000-insulation-board/) is a widely used general-purpose PIR board. Available in thicknesses from 25mm to 150mm.
...
**Breather membranes** (such as the [Tyvek Supro breather membrane](/building-materials/tyvek-supro-breather-membrane/)) are vapour-permeable but wind- and water-resistant. They sit on the cold side of the insulation, allowing moisture that penetrates the build-up to escape outward while keeping wind and rain out.
